...
def run_training(config_path, gpu):
    ...
    for r in r_values:
        ...
        cmd = [
            ...
            f"--data_path=ft-training_set/{dataset_name}.json",
            f"--data_length={config['data_length']}",
        ...
        try:
            ...
            if result.returncode != 0:
                ...
                print(f"Training completed successfully: {output_dir}")
